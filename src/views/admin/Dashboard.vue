                            ...
                            <div id="testimonial_slider" class="carousel slide" data-ride="carousel">
                              ...
                              <div class="carousel-inner">
                                  <div class="item carousel-item active">
                                    <div class="img-box"><img src="/images/admin/photos/6215.jpg" alt=""></div>
      ...
      <div class="row column4 graph">
          <div class="col-md-6 margin_bottom_30">
            <div class="dash_blog">
                <div class="dash_blog_inner">
                  <div class="dash_head">
                      <h3><span><i class="fa fa-calendar"></i></span> {{ getCurrentDate }}<span class="plus_green_bt"><a href="#">+</a></span></h3>
                  </div>
                  <div class="list_cont">
          ...
          <div class="col-md-6">
            <div class="dash_blog">
                <div class="dash_blog_inner">
                  <div class="dash_head">
                      <h3><span><i class="fa fa-comments"></i> Updates</span><span class="plus_green_bt"><a href="#">+</a></span></h3>
                  </div>
                  <div class="list_cont">
                  ...
                  <div class="msg_list_main">
                      <ul class="msg_list">
                        <li>
                            <span><img src="/images/admin/photos/6215.jpg" class="img-responsive" alt="#" /></span>
                            <span>
